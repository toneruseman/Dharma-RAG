...
>
> Задайте вопрос о технике медитации, отрывке из сутты или палийском термине — система найдёт точные места в курируемом корпусе, приведёт цитаты и ответит на вашем языке.
>
