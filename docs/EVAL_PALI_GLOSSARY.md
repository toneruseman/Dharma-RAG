...
- **Generated**: 2026-04-28T19:13:49+00:00
- **Git commit**: `00a0b5c`
...
|---|---:|---:|---:|---:|---:|---:|
| baseline_no_glossary | 0.190 | 0.450 | 0.540 | 0.650 | 0.308 | 7.51 |
| candidate_with_glossary | 0.200 | 0.450 | 0.530 | 0.660 | 0.313 | 6.58 |

**Δ ref_hit@5 = +0.0 pp**, **Δ MRR = +0.005**
...
| language | n | ref_hit@1 | ref_hit@5 | ref_hit@10 | ref_hit@20 | MRR |
|---|---:|---:|---:|---:|---:|---:|
| en | 91 | 0.220 | 0.473 | 0.560 | 0.692 | 0.336 |
...
|---|---|---|---|---|
| qa_021 | en | What is the relationship between sati and samādhi? | mn117, an4.41, sn47.4 | an3.101, dn10, sn47.4, dn10, an11.11 |

### Regressed by glossary

| id | lang | query | expected | baseline top-5 | candidate top-5 |
|---|---|---|---|---|---|
| qa_046 | en | Who was Mahā Moggallāna? | mn37, sn40.1 | sn51.31, sn40.1, sn51.14, an6.34, an6.34 | an1.188-197, sn6.5, sn40.7, sn44.8, sn40.5 |
